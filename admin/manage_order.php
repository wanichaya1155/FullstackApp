    ...
    <table>
        ...
        <?php
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo"<td>
                            <a href='order/print_invoice.php?purchaseNo=$purchaseNo&custno={$row['CustNo']}'>
                                <img src='img/print.jpg'>  
                            </a>
                        </td>";
                    echo "<td><a href='order/update.php?data=$purchaseNo'><img class='edit_img' src='img/edit.png'></a></td>";
