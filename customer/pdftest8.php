...
if(isset($_GET["purchaseNo"]) && isset($_GET["custno"])) {
    ...
    if(mysqli_num_rows($result_customer) > 0 && mysqli_num_rows($result_order) > 0) {
        ...
        // $pdf->Output('order'.$$orderNo.'.pdf', 'I');
        $pdf->Output('order.pdf', 'I');

        // Close MySQL connection
        mysqli_close($cx);
    } else {
        echo "ไม่พบข้อมูลลูกค้าหรือรายการสินค้า";
    }
} else {
    echo "ไม่พบข้อมูลใบสั่งซื้อหรือข้อมูลลูกค้า";
}
?>
